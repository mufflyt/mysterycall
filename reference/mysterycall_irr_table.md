...
- outcome_label:
  ...
  Character scalar. Column header for the combined estimate column.
  Default `"IRR (95% CI)"`.

- digits:

  Integer. Number of decimal places for rounding `irr`, `ci_lower`, and
  `ci_upper`. Default `2`.
...
A `gt_tbl` object ready for rendering or export.
