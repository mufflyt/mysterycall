...
Assign record identifiers for a fielded design (e.g. a REDCap import) so
that the identifier itself does not encode the treatment arm.

- [`mysterycall_assign_blinded_slots()`](https://mufflyt.github.io/mysterycall/reference/mysterycall_assign_blinded_slots.md)
  : Assign blinded record slots that don't encode a matched pair's
  treatment arm
