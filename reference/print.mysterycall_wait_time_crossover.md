...
full `summary(lm)` output.

## Usage

``` r
# S3 method for class 'mysterycall_wait_time_crossover'
print(x, digits = 2, ...)
```
...
- x:
  ...
  A `mysterycall_wait_time_crossover` object.

- digits:

  Integer. Decimal places for slope, intercept, and crossover point
  display. Default `2`.
