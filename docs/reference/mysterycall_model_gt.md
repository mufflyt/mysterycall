...
Extracts `$irr_table` from a `mysterycall_simple_poisson` object and
passes it to
...
``` r
mysterycall_model_gt(poisson_result, ...)
```
...
- poisson_result:
  ...
  An object of class `mysterycall_simple_poisson` (returned by
