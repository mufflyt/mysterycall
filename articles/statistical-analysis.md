...
#> for privately insured callers, compared with 64.0% (95% CI: 57.2% to 70.3%)
#> for Medicaid callers, 84.0% (95% CI: 78.1% to 88.8%) for Medicare callers,
#> and 54.0% (95% CI: 47.1% to 60.8%) for uninsured callers. Medicaid callers
...
#> Uninsured callers waited 29% longer (IRR 1.29; 95% CI: 1.06 to 1.57; p = .012).
#> No statistically significant wait-time difference was observed for Medicare
#> callers (IRR 1.08; 95% CI: 0.89 to 1.31; p = .441).
```
...
#> a significantly lower rate (63.8%; 95% CI: 48.3% to 76.9%), representing a
...
#> appointment-offered rate (55.0%; 95% CI: 39.6% to 69.7%), 37.5 percentage
...
#> p = .003). Uninsured callers waited 28% longer (IRR 1.28; 95% CI: 1.01 to 1.62;
