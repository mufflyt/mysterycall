...
#>        (Intercept)    21.66 2.03    17.69    25.63 < 0.001
#>  insuranceMedicaid     7.93 2.33     3.37    12.48   0.001
#>          waveWave2    -0.53 2.33    -5.08     4.03   0.822
#> 
...
#> 1 (Intercep…   21.7    2.03  10.7    73.4 1.28e-16 < 0.001        17.7     25.6 
#> 2 insurance…    7.93   2.33   3.41   58.0 1.19e- 3 0.001           3.37    12.5 
#> 3 waveWave2    -0.525  2.33  -0.226  58.0 8.22e- 1 0.822          -5.08     4.03
...
#> Fitting LMM: wait_days ~ insurance + wave + (1 | physician)
#> Warning: Overdispersion detected (phi = 3.72). Standard errors may be
...
#> 1 (Intercept)       21.7        2.03    10.7    73.4 1.28e-16    17.7      25.6 
#> 2 insuranceMedic…    7.93       2.33     3.41   58.0 1.19e- 3     3.37     12.5 
#> 3 waveWave2         -0.525      2.33    -0.226  58.0 8.22e- 1    -5.08      4.03
```
...
#> 1 insuranceMedicaid 7.9 (3.4 to 12.5), p = 0.001   5.7 (2.4 to 8.9), p = 0.001
#> 2         waveWave2  -0.5 (-5.1 to 4), p = 0.822 -0.5 (-3.7 to 2.8), p = 0.775
#>   Consistent
#> 1        Yes
#> 2        Yes
```
