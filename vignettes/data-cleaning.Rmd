...
```{r addr-ascii, purl=FALSE}
raw_addr <- "123 Café Boulevard, Suite 4A"
mysterycall_ascii_norm(raw_addr)
```

### 3b. Directional normalization (North → N, Northeast → NE)

```{r addr-directionals, purl=FALSE}
