...
test_that("mysterycall_progress_tracker creates valid S3 object", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Step1", "Step2", "Step3"))
...
test_that("mysterycall_progress_tracker initializes records tibble correctly", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Alpha", "Beta"))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
...
test_that("mysterycall_progress_start marks step as in_progress", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Task1"))
  suppressMessages(mysterycall:::mysterycall_progress_start(tracker, "Task1", note = "Starting task"))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
...
test_that("mysterycall_progress_finish marks step completed with quality", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Work"))
  suppressMessages(mysterycall:::mysterycall_progress_start(tracker, "Work"))
  suppressMessages(mysterycall:::mysterycall_progress_finish(tracker, "Work", score = 0.95))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
...
test_that("mysterycall_progress_finish with explicit quality overrides score", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Check"))
  suppressMessages(mysterycall:::mysterycall_progress_start(tracker, "Check"))
  suppressMessages(mysterycall:::mysterycall_progress_finish(tracker, "Check", score = 0.5, quality = "Excellent"))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
...
test_that("mysterycall_tracker_fail marks step as failed", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Risky"))
  suppressMessages(mysterycall:::mysterycall_progress_start(tracker, "Risky"))
  suppressMessages(mysterycall:::mysterycall_tracker_fail(tracker, "Risky", reason = "Timeout occurred"))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
...
test_that("mysterycall_tracker_update emits progress update", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("X", "Y"), update_every = 1e9)
  suppressMessages(mysterycall:::mysterycall_progress_start(tracker, "X"))
  suppressMessages(mysterycall:::mysterycall_progress_finish(tracker, "X"))
  expect_invisible(suppressMessages(mysterycall:::mysterycall_tracker_update(tracker, force = TRUE)))
})

# Test 8: Progress tracker with duplicates removes them
test_that("mysterycall_progress_tracker removes duplicate steps", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("A", "B", "A", "C"))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
...
test_that("mysterycall_progress_tracker respects quiet flag", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Silent"), quiet = TRUE)
...
test_that("mysterycall_progress_tracker errors on non-character steps", {
  expect_error(
    mysterycall:::mysterycall_progress_tracker(c(1, 2, 3)),
...
test_that("mysterycall_progress_tracker errors on empty steps", {
  expect_error(
    mysterycall:::mysterycall_progress_tracker(character(0)),
    "`steps` must be a non-empty character vector."
  )
})
...
test_that("mysterycall_progress_start errors on unknown step", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Known"))
  expect_error(
    mysterycall:::mysterycall_progress_start(tracker, "Unknown"),
...
test_that("mysterycall_progress_finish errors on unknown step", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Known"))
  expect_error(
    mysterycall:::mysterycall_progress_finish(tracker, "Unknown"),
    "Unknown step 'Unknown'."
  )
})
...
test_that("mysterycall_tracker_fail errors on unknown step", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Known"))
  expect_error(
    mysterycall:::mysterycall_tracker_fail(tracker, "Unknown"),
    "Unknown step 'Unknown'."
  )
})
...
test_that("mysterycall_progress_start errors on invalid tracker", {
  expect_error(
    mysterycall:::mysterycall_progress_start(list(), "Step"),
...
test_that("mysterycall_progress_summary returns tibble", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("A", "B"))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
...
test_that("multiple steps can be managed independently", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("First", "Second", "Third"))
  suppressMessages({
    mysterycall:::mysterycall_progress_start(tracker, "First")
    mysterycall:::mysterycall_progress_finish(tracker, "First", score = 0.9)
    mysterycall:::mysterycall_progress_start(tracker, "Second")
  })
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
  expect_equal(as.character(summary$status[1]), "completed")
...
test_that("mysterycall_progress_finish works on pending step", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Jump"))
  suppressMessages(mysterycall:::mysterycall_progress_finish(tracker, "Jump", score = 0.8))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
  expect_equal(as.character(summary$status[1]), "completed")
})
...
test_that("mysterycall_tracker_fail works on pending step", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("Pending"))
  suppressMessages(mysterycall:::mysterycall_tracker_fail(tracker, "Pending", reason = "Never started"))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
  expect_equal(as.character(summary$status[1]), "failed")
})
...
test_that("tracker functions return invisibly", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("A", "B"))
  expect_invisible(suppressMessages(mysterycall:::mysterycall_progress_start(tracker, "A")))
  expect_invisible(suppressMessages(mysterycall:::mysterycall_progress_finish(tracker, "B")))
  expect_invisible(suppressMessages(mysterycall:::mysterycall_tracker_fail(tracker, "B")))
  expect_invisible(suppressMessages(mysterycall:::mysterycall_tracker_update(tracker)))
})

# Test 21: Update_every parameter is stored
test_that("mysterycall_progress_tracker stores update_every parameter", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("X"), update_every = 60)
...
test_that("mysterycall_progress_start without note keeps NA", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("NoNote"))
  suppressMessages(mysterycall:::mysterycall_progress_start(tracker, "NoNote"))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
...
test_that("mysterycall_progress_finish without score or quality", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("NoScore"))
  suppressMessages(mysterycall:::mysterycall_progress_finish(tracker, "NoScore"))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
  expect_equal(as.character(summary$status[1]), "completed")
})
...
test_that("mysterycall_tracker_fail without reason keeps NA", {
  tracker <- mysterycall:::mysterycall_progress_tracker(c("NoReason"))
  suppressMessages(mysterycall:::mysterycall_tracker_fail(tracker, "NoReason"))
  summary <- mysterycall:::mysterycall_progress_summary(tracker)
  expect_true(is.na(summary$note[1]))
})
